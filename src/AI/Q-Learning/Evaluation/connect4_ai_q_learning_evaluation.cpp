// connect4_ai_q_learning_evaluation.cpp
// by Jake Charles Osborne III



#include "connect4_ai_q_learning_evaluation.h"
...
namespace connect4::ai {
	...
	vector<float> extractFeatures(const connect4::model::Board& board) {
		const bitset<47>& activePlayer = (board.getActivePlayer() == 1) ? board.player1 : board.player2;
		const bitset<47>& inactivePlayer = (board.getActivePlayer() == 1) ? board.player2 : board.player1;
